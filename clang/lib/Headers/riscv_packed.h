...
#define __packed_unary(name, rty, ty)                                          \
  static __inline__ rty __DEFAULT_FN_ATTRS                                     \
  __riscv_##name(ty __rs1) {                                                   \
    return __builtin_riscv_##name(__rs1);                                      \
  }

#define __packed_binary(name, rty, ty)                                         \
  static __inline__ rty __DEFAULT_FN_ATTRS                                     \
...
__packed_unary(pabs_i16x2, uint16x2_t, int16x2_t)
__packed_binary(pabd_i8x4, uint8x4_t, int8x4_t)
__packed_binary(pabd_i16x2, uint16x2_t, int16x2_t)
__packed_binary(pabdu_u8x4, uint8x4_t, uint8x4_t)
__packed_binary(pabdu_u16x2, uint16x2_t, uint16x2_t)
...
__packed_binary(pabd_i8x8, uint8x8_t, int8x8_t)
